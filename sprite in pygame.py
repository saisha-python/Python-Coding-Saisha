...
class Sprite(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # Flag to track if the sprite hits a boundry
        boundary_hit = False
        # Check for collision with left ir right boundaries and reverse direction
...
pygame.display.set_caption("Colorful Bounce: The Game Of Colors")
...
# Unintialize all pygame modules and close the game window
pygame.quit()